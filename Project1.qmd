...
# Wrapper function
processing_wrapper <- function(url,column_name='Enrollment'){
  result <- read_csv_code(url) |>
    (\(data)function_for_steps_1_2(data,column_name))() |>
    (\(data_2)function_for_step_3(data_2,column_name))() |>
    function_for_steps_4_5_6()
  return(result)
}


processing_wrapper("https://www4.stat.ncsu.edu/~online/datasets/EDU01b.csv")

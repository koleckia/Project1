...
#    current_input_c <- input[[i]]
#    county_data <- bind_rows(current_input_c[1:6])
#    return(county_data)
#    current_input_s <- input[[i]]
#    noncounty_data <- bind_rows(current_input_s[7:11])
#    return(noncounty_data)
#  }
